    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16 container mx-auto px-4 py-12">
        <section className="text-center">
          <h1 className="text-4xl font-bold mb-6 text-primary">Get Started</h1>
          <p className="text-secondary max-w-2xl mx-auto">
            Ready to begin your journey? Follow these simple steps to get started with our application.
          </p>
